...
type DeletePurchaseOrderDialogProps = {
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            <strong>{purchaseOrder.poNumber}</strong>? This action cannot be
            undone and may affect related inventory updates associated with this
            purchase order.
          </AlertDialogDescription>
        </AlertDialogHeader>
